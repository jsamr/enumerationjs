...
- `enumValues` : an object containing the set of enum values. Keys are enum value names and values can either be :
    * a unique identifier of type string or number  (example in [JS](JS.GUIDE.MD#basicusage) | [COFFEE](COFFEE.GUIDE.MD#basicusage))      
    * a structured descriptor (example in [JS](JS.GUIDE.MD#usemorecomplexenumdescriptors) | [COFFEE](COFFEE.GUIDE.MD#usemorecomplexenumdescriptors))   
