...
> ✓ Last Jasmine test run was the 10/21/15 at 19:24 UTC  with 
**41 specs, 0 failures**
...
- ✓ You can hack a class ([JS](JS.GUIDE.MD#hackdaclass:incorporateaspublicclassfields)|[COFFEE](COFFEE.GUIDE.MD#hackdaclass:incorporateaspublicclassfields)) to have all the defined values of your Enumeration instance as static fields of this `class`.  
