...
**KEY POINTS**
  ...
  ℹ Fully **CommonJS** and **AMD** compliant through a **Universal Module Definition** | since v1.3.0     
  ℹ Available for **npm**, **bower** and **Meteor**, see the [dependency managers section](#dependencymanagers)  
